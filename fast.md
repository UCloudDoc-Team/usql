...
2、点击刷新并确认数据库database01出现在选项中。 ![](/images/创建数据库.png)

### 3.3 创建表

1、选择数据库database01，点击‘创建数据表’。 ![](/images/创建数据表.png)

2、输入表名称、数据存储位置，选择数据格式并输入字段列表，然后点击创建数据表。 ![](/images/创建数据表2.png)
![](/images/数据表.png)
...
点击‘立即运行’，返回查询结果如图，可以选择全屏查看结果或下载结果。 ![](/images/运行结果.png)
